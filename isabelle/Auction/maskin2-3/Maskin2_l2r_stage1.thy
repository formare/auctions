...
proof - (* see LaTeX *)
  ...
  have 
    17: "?RH=p``{b}" 
using all_not_in_conv  l5 runiq_def subsetI subset_singletonD the_elem_eq trivial_def
assms(3) "15" DomainE Image_singleton_iff by (metis (no_types,hide_lams))
    {
